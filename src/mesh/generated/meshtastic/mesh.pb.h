...
typedef PB_BYTES_ARRAY_T(32) meshtastic_User_x3dh_shared_key_t;
...
typedef struct _meshtastic_User {
 ...
 Not filled when not including the X3DH-module, therefore taking no storage and being reverse compatible */
    ...
    meshtastic_User_x3dh_shared_key_t x3dh_shared_key;
} meshtastic_User;
...
#define meshtastic_User_init_default             {"", "", "", {0}, _meshtastic_HardwareModel_MIN, 0, _meshtastic_Config_DeviceConfig_Role_MIN, {0, {0}}, false, 0, false, {0, {0}}}
...
#define meshtastic_User_init_zero                {"", "", "", {0}, _meshtastic_HardwareModel_MIN, 0, _meshtastic_Config_DeviceConfig_Role_MIN, {0, {0}}, false, 0, false, {0, {0}}}
...
#define meshtastic_User_x3dh_shared_key_tag      10
...
#define meshtastic_NodeInfo_size                 358
...
#define meshtastic_User_size                     149
